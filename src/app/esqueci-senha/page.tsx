...
export default function EsqueciSenhaPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col desktop:flex-row bg-white relative">
      <div className="flex w-full flex-col justify-center mobile:justify-between px-4 py-12 tablet:px-6 desktop:flex-none desktop:w-1/2 desktop:px-20 wide:px-24 relative min-h-[460px]">
