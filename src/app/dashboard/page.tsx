            ...
            <div className="grid grid-cols-1 tablet:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-[#EAE7EC] rounded-xl overflow-hidden flex flex-col h-full">
                <div className="h-48 relative">
                  <Image
                    src="/images/cross-sell/cross-sell-sula-profissoes.png"
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">SulAmérica Profissões</h3>
                  <p className="text-sm text-gray-600 mb-4 flex-grow">
                    Cobertura completa para tratamentos odontológicos com os melhores profissionais da rede credenciada.
                  </p>
                  <a 
                    href="https://cloud.marketing.sulamerica.com.br/profissoes"
                    target="_blank"
              ...
              <div className="bg-white border border-[#EAE7EC] rounded-xl overflow-hidden flex flex-col h-full">
                <div className="h-48 relative">
                  <Image
                    src="/images/cross-sell/cross-sell-sula-seguro-vida.png"
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">SulAmérica Seguro de Vida</h3>
                  <p className="text-sm text-gray-600 mb-4 flex-grow">
                    Cobertura completa para tratamentos odontológicos com os melhores profissionais da rede credenciada.
                  </p>
                  <a 
                    href="https://encr.pw/66Cgm"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full"
                  >
              ...
              <div className="bg-white border border-[#EAE7EC] rounded-xl overflow-hidden flex flex-col h-full">
                <div className="h-48 relative">
                  <Image
                    src="/images/cross-sell/cross-sell-sula-dentista.png"
                    alt="Plano Dentista"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">SulAmérica Seguro Dentista</h3>
                  <p className="text-sm text-gray-600 mb-4 flex-grow">
                    Cobertura completa para tratamentos odontológicos com os melhores profissionais da rede credenciada.
                  </p>
                  <a 
                    href="https://dentistasula.plataformadeseguros.com.br/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full"
                  >
