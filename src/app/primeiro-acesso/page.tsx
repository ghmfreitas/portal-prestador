...
export default function PrimeiroAcessoPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col desktop:flex-row bg-white relative">
      <div className="flex w-full flex-col justify-center mobile:justify-between px-4 py-12 tablet:px-6 desktop:flex-none desktop:w-1/2 desktop:px-20 wide:px-24 relative">
        <div className="mobile:block hidden"></div>
        <div className="mx-auto w-full max-w-sm desktop:w-96 mobile:pt-20 mobile:pb-20">
          <div>
            <Image 
