...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col desktop:flex-row bg-white relative">
      <div className="flex w-full flex-col justify-center mobile:justify-between px-4 py-12 tablet:px-6 desktop:flex-none desktop:w-1/2 desktop:px-20 wide:px-24 min-h-[460px]">
        <div className="mobile:block hidden"></div>
        <div className="mx-auto w-full max-w-sm desktop:w-96 mobile:min-h-[460px]">
          <div>
            <Image 
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Button 
                    ...
                    disabled={isLoading || !codigo || !senha}
                  >
                    {isLoading ? (
                      <>
      ...
      <div className="relative flex-1 w-full desktop:w-1/2 min-h-[300px] desktop:min-h-0 hidden desktop:block">
        <Image 
